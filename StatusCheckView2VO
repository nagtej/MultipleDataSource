...
@Entity
public class StatusCheckView2VO {
	
	 protected StatusCheckView2VO() {}
	 
	 public StatusCheckView2VO(String serialPin, String maximoLCStatus,String maximoFinStatus,Date TermDt) {
